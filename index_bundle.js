...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   clearData: () => (/* binding */ clearData),\n/* harmony export */   processedData: () => (/* binding */ processedData),\n/* harmony export */   search: () => (/* binding */ search)\n/* harmony export */ });\n/* harmony import */ var _API__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./API */ \"./src/API.js\");\n/* harmony import */ var _rendering_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rendering.js */ \"./src/rendering.js\");\n\n\n\n\nlet processedData;\nfunction clearData(data) {\n    processedData = {\n        'location' : {\n            'name' : data.location.name,\n            'region' : data.location.region,\n            'country' : data.location.country,\n            'localtime' : data.location.localtime,\n        },\n        'current' : {\n            'condition' : {\n                'text' : data.current.condition.text,\n                'icon' : data.current.condition.icon,\n                'code' : data.current.condition.code,\n            },\n            'last_updated' : data.current.last_updated,\n            'temp_c': data.current.temp_c,\n            'temp_f': data.current.temp_f,\n            'is_day' : data.current.is_day,\n        }\n    }\n    console.log(data)\n};\n\n\n(function() {\n    document.querySelector('#search').addEventListener('click', search)\n})();\n\nasync function search() {\n    let input = document.querySelector('input').value;\n    //set default\n    if (input == '') {\n        input = 'cambiago'\n    };\n    (0,_rendering_js__WEBPACK_IMPORTED_MODULE_1__.loadingScreen)();\n    const data = await (0,_API__WEBPACK_IMPORTED_MODULE_0__.fetchInputData)(input);\n    await clearData(data);\n    //rendering\n    (0,_rendering_js__WEBPACK_IMPORTED_MODULE_1__.renderMainData)(processedData);\n    (0,_rendering_js__WEBPACK_IMPORTED_MODULE_1__.removeLoadScreen)();\n    //log\n(function logData() {\n    setTimeout(() => {console.log(processedData)}, 500);    \n}) ();\n};\n\n\n\n//# sourceURL=webpack://template/./src/processData.js?");
...
eval("module.exports = __webpack_require__.p + \"f4f06341e9cd0081875f.png\";\n\n//# sourceURL=webpack://template/./src/weatherBG.png?");
